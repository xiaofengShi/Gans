'''
Filename: img2imgDataset.py
Project: paint_x2_unet
File Created: Friday, 12th October 2018 6:27:43 pm
Author: xiaofeng (sxf1052566766@163.com)
--------------------------
Last Modified: Friday, 2nd November 2018 12:22:57 pm
...
class ImageAndRefDataset(chainer.dataset.DatasetMixin):
    ...
    def __init__(self, paths, root1='./input', root2='./ref', dtype=np.float32):
        self._paths = paths
        self._root1 = root1  # input sketch
        self._root2 = root2  # input color lines, this is the color guide
        self._dtype = dtype
...
class Image2ImageDatasetX2(Image2ImageDataset):
    ...
    def get_example(self, i, minimize=False, log=False, bin_r=0):
        ...
        return image1.transpose(
            2, 0, 1), image2.transpose(
            2, 0, 1), _image1.transpose(
            2, 0, 1), _image2.transpose(
            2, 0, 1)


class Image2SketchDataset(chainer.dataset.DatasetMixin):
