...
:fire:This repo is forked form the [URL😄](https://github.com/soumith/ganhacks), Thanks to the authors.
...
- Tanh as the last layer of the generator output, make the pro between [-1,1]
...
![batchmix](assets/batchmix.png "BatchMix")
